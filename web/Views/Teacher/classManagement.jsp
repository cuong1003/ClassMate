...
<html>
    ...
    <body>
        ...
        <c:if test="${user.role == 1}">
            <!-- 🔴 FORM RỜI KHỎI LỚP -->
            <form method="post" action="${pageContext.request.contextPath}/s/leaveclass" onsubmit="return confirm('Bạn có chắc chắn muốn rời khỏi lớp không?');">
                <input type="hidden" name="ccode" value="${ccode}">
                <button type="submit" style="background-color: crimson;">Rời khỏi lớp</button>
            </form>
        </c:if>
